...
<div class="container">
    ...
    <div id="1">
        ...
        <div class="slider-container">
            <ul id="slides">
                <li class="slide showing"><img style="margin-left:6ex;" width="700" height="470"  alt="1" src="1.jpg"></li>
                <li class="slide"><img style="margin-left:6ex;" width="700" height="470" src="2.jpg" alt="2"></li>
                <li class="slide"><img style="margin-left:6ex;" width="700" height="470" src="3.jpg" alt="3"></li>
                <li class="slide"><img style="margin-left:6ex;" width="700" height="470" src="4.jpg" alt="4"></li>
            </ul>
            <div class="buttons">
